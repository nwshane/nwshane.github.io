...
The next time I took a look at this bug was a few days later, when I met up with Harold Treen, a fellow Recurser and JavaScript enthusiast.
...
Finally, Harold found this d3-request [issue](https://github.com/d3/d3-request/issues/24) and (commit)[https://github.com/d3/d3-request/commit/d635b894fee995930f7419189255da8e66062710] which seems to have led to this whole issue.
...
There are a few takeaways I’d like to remember from this debugging adventure, namely:
...
Thanks to the people behind gatsby, webpack, and d3, for making these libraries and providing me with some occasional debugging practice, and to Harold Treen for helping me get out of this mess.
